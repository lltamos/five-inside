...
public class InitParams {
	...
	public  static String redis_port=null;
	...
	public void init() throws IOException {
		...
		redis_port=properties.getProperty("redis_port");
		check_msg_url=properties.getProperty("check_msg_url");
		send_msg_url=properties.getProperty("send_msg_url");
